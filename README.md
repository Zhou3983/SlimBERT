...
I studied how to compress the BERT model in a structured pruning
manner. I proposed the neural slimming technique to assess the importance of each
...
tasks, the model can learn a more compact structure, and it is named SlimBERT. My thesis is available [here](https://uwspace.uwaterloo.ca/handle/10012/18586).
